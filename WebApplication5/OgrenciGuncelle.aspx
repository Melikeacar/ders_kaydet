 <%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="OgrenciGuncelle.aspx.cs" Inherits="WebApplication5.OgrenciGuncelle" %>
...
<asp:TextBox ID="TxtFoto" runat="server" CssClass="form-control"></asp:TextBox>
    ...
    <asp:Button ID="Button1" runat="server" Text="Güncelle" CssClass="btn btn-warning" OnClick="Button1_Click" /></form>
